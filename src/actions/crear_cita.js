...
const crear_cita = function(d_cita, d_documento, p_paciente, p_patron, p_oci) {
    ...
    var cita = Cita();
    cita.setAuo(d_cita.auo);
    cita.setHora(d_cita.hora);
    cita.setFecha(d_cita.fecha);
    cita.setDoc_completa(d_cita.doc_completa);
    cita.setNota(d_cita.nota);
